  ...
  _createClass(Panel, [{
    ...
    value: function render() {
      return React.createElement(
        "div",
        { className: "col-8 text-center text-white border border-white" },
        React.createElement(
          "div",
          { className: "row" },
          React.createElement(InPanel, null),
          React.createElement(InputMonitor, null)
        ),
        React.createElement(
          "div",
          { className: "row" },
          React.createElement(QuackPanel, null),
          React.createElement(ReadOuts, null)
        ),
        React.createElement(
          "div",
          { className: "row" },
          React.createElement(OutPanel, null)
        )
      );
    }
  }]);
